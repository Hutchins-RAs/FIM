...
**CBO Projections** 
Lastly, we use CBO projections for real potential GDP growth and GDP growth. Potential GDP growth is used in our FIM calculation, and GDP growth is used to generate GDP projections for our 8-quarter forecast period. 

CBO updates it's Economic Projections and 10-Year Budget Projections every couple of months. We add these revised numbers to our forecast sheet so we can easily see CBO's estimates as we are adjusting our own forecasts. We also store CBO's projections as an R data set in `data_raw/projections.RDS`. See Nasiha's FIM guide for instructions on how we overwrite this file when CBO publishes new projections. It's important to follow her guidelines carefully! 
