...
previous_inputs <-
  ...
  readxl::read_xlsx(glue('results/05-2026/05.05 published/beta/inputs-05-2026.xlsx')) %>%
  #WHAT IT USED TO BE 
...
previous <-
  #EDIT WHEN NOT JANK (REMOVE)
  readxl::read_xlsx(glue('results/05-2026/05.05 published/beta/contributions-05-2026.xlsx')) %>%
  #WHAT IT USED TO BE 
