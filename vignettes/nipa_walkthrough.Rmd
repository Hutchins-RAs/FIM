...
$$ 
4 \times \frac{\left(G_{i, t} -  G_{i, t - 1} \times (1 + \pi_{i,  t} )  \right) }{Y_{t-1}}
$$

where $$i = {\text{Federal purchases, state purchases, federal grants}}$$. We could compute this in `R` as follows:
```{r}
nipa %<>%
