...
usna_processed %>% 
  summarise(date, state_social_benefits, gross = state_social_benefits + medicaid) %>% 
  filter_index("2020 Q2" ~ "2020 Q4")
...
consumption <-
  projections %>% 
  mutate(federal_social_benefits = federal_social_benefits - rebate_checks, social_benefits = federal_social_benefits + state_social_benefits) %>% 
