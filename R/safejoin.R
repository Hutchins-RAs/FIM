...
#     federal_ui,
#     state_ui,
#     other_federal_social_benefits = nonprofit_ppp + nonprofit_provider_relief +  eitc
#   )
# 
# 
# 
...
#   
#   mutate(
#     other_federal_social_benefits = nonprofit_ppp + nonprofit_provider_relief_fund + eitc,
#     
