...
fim <- 
 ...
 tsibble::filter_index('1999 Q4' ~ '2023 Q3')
```
...
headline_plot <-
  ggplot(data = headline) +
    geom_rect(data = recessions %>% 
            filter(recession_start > yearquarter('1999 Q4')),
  ...
  annotate("rect", xmin = yearquarter('2021 Q4'), xmax = yearquarter('2023 Q3'),
...
expanded <-
  ...
  ggplot(data = expanded) +
     ...
     scale_color_manual(" ", 
                        values=c("4-quarter moving-average" ="black")) +
      annotate("rect", xmin = projection_start, xmax = yearquarter('2023 Q3'),
               ymin = -Inf, ymax = Inf, alpha = 0.1, fill = 'yellow') +
...
template <- 
  list(
     ...
     scale_color_manual(" ", 
                        values=c("4-quarter moving-average" ="black")) ,
      annotate("rect", xmin = projection_start, xmax = yearquarter('2023 Q2'),
               ymin = -Inf, ymax = Inf, alpha = 0.1, fill = 'yellow'),
      # scale_x_yearquarter(breaks = 0, date_breaks = "2 years", date_labels = '%Y Q%q',
      #              expand = c(0,0)) , 
