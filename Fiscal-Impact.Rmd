...
expanded <- expanded %>%
  mutate(variable = factor(variable, levels = c("federal_contribution",
                                                "state_contribution",
                                                "consumption_contribution")))
  ...
  scale_x_yearquarter(expand = expansion()) +
     ...
     scale_fill_fim(palette = 'expanded',
               labels = c("federal_contribution" = " Federal Purchases",
                          "state_contribution" = " State & Local Purchases",
                          "consumption_contribution" = " Taxes, Transfers, & Subsidies")) + 
     scale_color_manual(" ", 
                        values=c("4-quarter moving-average" ="black")) +
      annotate("rect", xmin = projection_start, xmax = yearquarter(params$end),
               ymin = -Inf, ymax = Inf, alpha = 0.2, fill = 'yellow') +
